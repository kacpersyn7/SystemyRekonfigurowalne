...
#
# Generated by export_simulation on Fri Apr 06 15:59:10 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './c_addsub_DE.sh' script.

./c_addsub_DE.sh -reset_run
...
./c_addsub_DE.sh -noclean_files

For more information on the script, please type './c_addsub_DE.sh -help'.
