...
#
# Generated by export_simulation on Fri Apr 06 16:01:35 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './c_addsub_all.sh' script.

./c_addsub_all.sh -reset_run
...
./c_addsub_all.sh -noclean_files

For more information on the script, please type './c_addsub_all.sh -help'.
