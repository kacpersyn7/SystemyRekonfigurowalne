...
#
# Generated by export_simulation on Fri Apr 06 16:27:15 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './c_addsub_EF.sh' script.

./c_addsub_EF.sh -reset_run
...
./c_addsub_EF.sh -noclean_files

For more information on the script, please type './c_addsub_EF.sh -help'.
