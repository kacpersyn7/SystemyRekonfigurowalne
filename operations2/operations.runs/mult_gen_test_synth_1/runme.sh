...
HD_PWD='D:/Users/Kacper/Documents/SystemyRekonfigurowalne/operations/operations.runs/mult_gen_test_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_gen_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_gen_test.tcl
