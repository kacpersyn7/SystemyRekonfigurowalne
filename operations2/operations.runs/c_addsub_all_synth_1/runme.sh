...
HD_PWD='D:/Users/Kacper/Documents/SystemyRekonfigurowalne/operations/operations.runs/c_addsub_all_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_addsub_all.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_addsub_all.tcl
