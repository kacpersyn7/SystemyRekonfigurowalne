...
HD_PWD='/home/kacper/SystemyRekonfigurowalne/vp_bin/vp.runs/dist_mem_gen_R_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_gen_R.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_gen_R.tcl
