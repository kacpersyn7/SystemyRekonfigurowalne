...
HD_PWD='/home/lsriw/sr/SynowiecKacper/hdmi_vga_zybo/hdmi_vga_zybo.runs/hdmi_vga_xlconstant_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_vga_xlconstant_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_vga_xlconstant_0_0.tcl
