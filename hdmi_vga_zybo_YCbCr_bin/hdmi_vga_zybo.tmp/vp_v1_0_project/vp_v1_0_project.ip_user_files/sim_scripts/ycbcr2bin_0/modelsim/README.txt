...
#
# Generated by export_simulation on Mon May 28 09:42:12 CEST 2018
#
################################################################################
...
'-reset_run' switch to the './ycbcr2bin_0.sh' script.

./ycbcr2bin_0.sh -reset_run
...
./ycbcr2bin_0.sh -noclean_files

For more information on the script, please type './ycbcr2bin_0.sh -help'.
