...
#
# Generated by export_simulation on Mon May 28 09:46:15 CEST 2018
#
################################################################################
...
'-reset_run' switch to the './centroid_0.sh' script.

./centroid_0.sh -reset_run
...
./centroid_0.sh -noclean_files

For more information on the script, please type './centroid_0.sh -help'.
