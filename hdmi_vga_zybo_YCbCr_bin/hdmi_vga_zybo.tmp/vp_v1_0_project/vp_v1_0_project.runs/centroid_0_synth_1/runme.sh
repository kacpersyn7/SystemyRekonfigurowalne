...
HD_PWD='/home/lsriw/sr/SynowiecKacper/kacper_git2/SystemyRekonfigurowalne/hdmi_vga_zybo_YCbCr_bin/hdmi_vga_zybo.tmp/vp_v1_0_project/vp_v1_0_project.runs/centroid_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log centroid_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source centroid_0.tcl
