...
HD_PWD='/home/lsriw/sr/SynowiecKacper/kacper_git2/SystemyRekonfigurowalne/centroid/centroid.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log centroid.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source centroid.tcl
