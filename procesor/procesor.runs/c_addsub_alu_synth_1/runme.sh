...
HD_PWD='/home/kacper/sr/SystemyRekonfigurowalne/procesor/procesor.runs/c_addsub_alu_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_addsub_alu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_addsub_alu.tcl
