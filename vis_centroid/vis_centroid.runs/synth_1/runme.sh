...
HD_PWD='/home/kacper/sr/SystemyRekonfigurowalne/vis_centroid/vis_centroid.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vis_centroid.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vis_centroid.tcl
