...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L xlconstant_v1_1_3 -L dist_mem_gen_v8_0_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot hdmi_vga xil_defaultlib.hdmi_vga xil_defaultlib.glbl -log elaborate.log
}
